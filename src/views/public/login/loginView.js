export function loginView() {
    return `
        ...
        <div class="relative w-4/5 h-fit border-b-4 border-[#22D3EE] bg-[#1E293B]/50 overflow-visible mt-5">

            <img 
                src="./img/sinFondo/juan_avatar_espiando_mirando_al_frente-removebg-preview.png" 
                alt="Avatar espiando" 
                class="espia absolute -bottom-2 left-1/2 -translate-x-1/2 w-32 h-auto object-contain"
            >

        </div>
        <h1 class="w-4/5 start-2p text-center text-[#F8FAFC] text-xl mt-2">
            INICIA SESION
        </h1>

            <form action="" method="post" class="formLogin w-full h-fit flex flex-col justify-center items-center">
            <div class="relative flex flex-col w-4/5 h-10 mt-8">
                ...
                <span id="error-email" class="hidden text-[#F472B6] text-[0.4rem] start-2p absolute -bottom-3">
            ...
            <div class="relative flex flex-col w-4/5 h-12 mt-8">
                ...
                <span id="error-password" class="hidden text-[#22D3EE] text-[0.4rem] start-2p absolute -bottom-1">
                    *** Debes agregar la contraseña ***
                </span>                
            </div>
            
            <div class="w-full h-8 flex justify-start px-5 mt-4">
                <label for="seePassword" class="w-54 h-8 flex items-center group cursor-pointer">
                    ...
                    <div class="w-5 h-5 mx-2 border-2 border-[#22D3EE] rounded-sm transition-all duration-300 peer-checked:bg-[#22D3EE]  peer-checked:shadow-[0_0_10px_#22D3EE]flex items-center justify-center">
                        <svg class="w-5 h-5 text-[#0F172A] opacity-0 peer-checked:opacity-100 transition-opacity duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="4" d="M5 13l4 4L19 7"></path>
                        </svg>
                    </div>
        ...
        <div class="w-full h-10 mt-5 flex justify-start items-center px-7">
